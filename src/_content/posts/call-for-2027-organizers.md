...
author: DEFNA Board
category: General
published_datetime: 2026-08-26 12:00:00-05:00
layout: post
title: "Call for Organizers: DjangoCon US 2027"
---

DjangoCon US 2026 has just about wrapped up! We are already planning for [DjangoCon US 2027](https://2027.djangocon.us), and we need organizers to help make DCUS 2027 the best it can be.

<!-- excerpt -->

We have some [documentation about the various roles](https://docs.djangocon.us/), but here's a quick overview of the teams at DjangoCon US.
...
The conference chair and co-chair lead the conference, including coordinating between teams and making executive decisions (including approaching the DEFNA board when applicable). Expect to be in meetings with the venue and online conference provider, weekly organizer check-ins, monthly reports to the DEFNA board, and lots of questions on Slack. You'll also lead the volunteer kickoff meetings in early 2027 (ideally mid-to-late January) and recruit organizers as you see fit.

At the conference, you'll be making speeches at the start of each day (or pick an organizer to do so) and the end-of-conference wrap-up in addition to coordinating setup, teardown, and everything in between.
...
- Start the call for proposals process (opening no later than mid-January)
...
- Recruit speaker mentors (start with emailing the 2026 speakers in Pretalx and bring in more as you like)
...
- Recruit talk reviewers (the DEFNA board will send you the 2026 reviewers, but more reviewers are encouraged, especially from diverse backgrounds). There will be over 100 submissions, so having more reviewers lessens the load for individual talks
- Decide on any tweaks to the format (Stick with single-track? Spanish-language talks? Keep the Deep Dive Day? This is your chance to put your mark on the program)
- Review talks
...
- Conduct a Code of Conduct review of potential speakers
- Coordinate with the OG team to notify speakers in waves (ideally completed by June 15)
- Build a schedule (ideally by July 1)
- Publish blog posts announcing speakers and keynotes (ideally by July 15)
...
- Check with tutorial speakers (if we are having them) to make sure they have everything they need

## Opportunity Grants Committee

Size: 1-2 (plus reviewers)
...
- Arrange childcare and lactation/wellness room
- Coordinate visa applications
- Improve accessibility of the venue and conference as a whole
- Reach out to local Python user groups to market the conference
...
- Work with sponsor chair/co-chair to handle sponsor shout-outs when needed
- Order banners to go behind the speakers on stage and at venue entrances
...
The venue committee is responsible for coordinating plans between the other organizing teams and the venue(s). Ideally at least one person in this committee lives near the conference and can visit the venue frequently.
...
- Select an online conference provider
- Recruit and schedule online moderators

### During-conference responsibilities

- Increase online engagement during the conference
- Adjust live-streaming URLs for each day of the talks
...
- Coordinate with external designer on T-shirt, swag bag, and banner designs
- Order attendee t-shirts (with sponsor logos)
- Order swag bags (with sponsor logos)
- Design and order speaker gifts
- Order DCUS-branded swag (stickers/magnets/etc.)
...
- Get T-shirts and swag bags to the registration desk, ideally sorted by size and cut for rapid distribution
- Get speaker gifts to the volunteer team for distribution
...
- Draft announcements for calls for volunteers (blog post + social media)

### At-conference responsibilities

- Tell volunteers where to go
- Give volunteers tools to succeed
- Coordinate thank-you note signing by organizezrs

## Marketing Committee

Size: 2-4

The marketing committee is responsible for getting the word out about DCUS.
...
- Post on social media early and often.
- Select an "official emoji" for the conference (typically suggested by the design package for the year's website)
- Boost speakers and organizers talking about the conference
- Schedule posts announcing talks and events
...
- Meet with external designer to design the conference website
- Implement designs from external designer
...
- Direct people to lunches and breaks (if offered)

## Wrap-up

To sign up for any of the teams (or just say "Put me to work"), send an email to hello@djangocon.us and we'll add you to our organizer Slack instance and invite you to our organizer meetings once they start. We would love to have you! You do not have to have previous organizing experience (although we will probably prefer it for some of the leadership roles).
